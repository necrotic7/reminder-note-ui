            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <h1 className="text-2xl font-bold text-base-content">載入中...</h1>
                        <p className="py-2 text-base-content/70">正在初始化 LINE 登入服務</p>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="hero-content text-center">
                <div className="max-w-md">
                    <div className="mb-8">
                        ...
                        <h2 className="text-4xl font-bold text-base-content mb-2">歡迎使用 提醒助手</h2>
                        <p className="text-base-content/70 mb-6">請使用 LINE 帳號登入以繼續使用服務</p>
                    </div>
                    <div className="card w-full max-w-sm shadow-xl bg-base-100">
                        <div className="card-body items-center text-center">
                            ...
                            <div className="divider text-xs text-base-content/50">安全快速登入</div>
